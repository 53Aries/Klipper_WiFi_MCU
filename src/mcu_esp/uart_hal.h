/**
 * uart_hal.h - UART hardware abstraction for MCU ESP32-C5
 *
 ...
 *
 * Pins (see kwm_protocol.h, override in sdkconfig):
 *   TX  GPIO16 → STM32 RX
 *   RX  GPIO17 ← STM32 TX
 */
 ...
 */
typedef void (*uart_hal_rx_cb_t)(const uint8_t *data, size_t len);
